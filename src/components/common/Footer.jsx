    ...
    <footer className="site-footer">
      <div className="footer-main footer-reference-grid">
        ...
        <div className="footer-reference-links">
          ...
          <div><p className="footer-label">Headquarters</p><p className="footer-address">N.I.T Road, Chundappuram<br />Koduvally, Kozhikode 673572<br />Kerala, India<br /><a href="tel:+918129555591">+91 81295 55591</a></p></div>
        </div>
      </div>
